...
export const en = {
  ...
  home: {
    ...
    about: {
      ...
      p2: 'My journey began at the Boccioni Multimedia Art High School and was solidified with a Bachelor’s in Graphic Design from IED Milano. I am currently evolving toward prototyping and Interaction Design at SUPSI.',
      experienceLabel: 'Experience',
      portraitAlt: 'Chiara Baldini, Graphic & Interaction Designer',
      education: [
        { year: '2014/15-2018/19', label: 'Liceo Artistico Boccioni', detail: 'Multimedia Art' },
        { year: '2021-2024', label: 'IED Milano', detail: 'BA Graphic Design' },
  ...
  contact: {
    ...
    title: 'Let’s talk.',
    intro:
      'Let’s get to know each other. If you’re interested in collaborating or just want to chat about design, drop me a line!',
