 ...
 *
 * NOTE: `url` is the production domain. Replace it with the real domain when
 * known — everything (canonicals, sitemap, robots, OG URLs) derives from here.
 */
export const SITE = {
  name: 'Chiara Baldini',
  role: 'Graphic & Interaction Designer',
  url: 'https://chiarabaldini.com',
  description:
